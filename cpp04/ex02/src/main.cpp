...
int main()
{
	...
	delete i;
	// Animal animal();//It's Not Possible to create a instance to an Abstract Class
...
//==============================================//
	...
	for (int index = 0; index < 10; index++)
	{
		...
		// if (index == 6)
		 	//animal[index] = new Animal(); //It's Not Possible to create a pointer to an Abstract Class
		else
